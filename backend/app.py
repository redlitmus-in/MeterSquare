...
def create_app():
    ...
    if environment == "production":
        ...
        CORS(app,
             ...
             allow_headers=["Content-Type", "Authorization", "X-Request-ID", "X-Viewing-As-Role", "X-Viewing-As-Role-Id", "X-Viewing-As-User-Id", "Cache-Control", "Pragma", "X-Skip-Cache", "Expires"],
