...
import { Users, Clock, FileText, ChevronDown, ChevronUp, TrendingUp, TrendingDown, Lock, AlertCircle } from 'lucide-react';
            ...
            <tr>
              ...
              {showActual && (
                <>
                  ...
                  <th className="text-right py-3 px-3 text-gray-700 font-bold text-xs uppercase">Variance (Planned vs Actual)</th>
                </>
              )}
            </tr>
          </thead>
